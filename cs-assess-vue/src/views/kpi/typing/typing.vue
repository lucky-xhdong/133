    ...
    <el-row class="tsc-form-wrapper">
      ...
      <el-form :inline="true" :model="queryForm" ref="queryForm" class="pc-form">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="downloadTypingTemplate">下载模版</el-button>
        </el-form-item>
      </el-form>
      <!-- form表单 查询条件 end -->
    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      downloadTypingTemplate() {
        ...
        const url = process.env.BASE_API + '/csaExcel/excelDownload/downloadTypingTemplate?assessDate=' + params.assessDate + '&timestamp=' + new Date().getTime()
        // 创建隐藏的可下载链接
        this.iframeSrc = url
